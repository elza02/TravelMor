...
urlpatterns = [
    ...
    path('admin_page/dashboard/supp_reservation_voyage/<int:id_reservation>/', views.supp_reservation_voyage, name='supp_reservation_voyage'),
    path('admin_page/dashboard/supp_reservation_hotel/<int:id_reservation>/', views.supp_reservation_hotel, name='supp_reservation_hotel'),
    #login/logout
    path('login/', views.login, name="login"),
    path('logout/', views.logout, name='logout'),
    path('paiement/<str:id_vol>/', views.paiement, name='paiement'),
    path('paiement_hotel/<str:id_hotel>/', views.paiement_hotel, name='paiement_hotel'),
]
