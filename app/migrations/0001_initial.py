    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this utilisateur belongs to.', related_name='utilisateur_groups', to='auth.group')),
                ('id_hotel', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.hotel')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this utilisateur.', related_name='utilisateur_user_permissions', to='auth.permission')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.hotel')),
                ('id_promotion', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.promotion')),
            ],
        ),
        migrations.CreateModel(
            name='ReserverVoyage',
